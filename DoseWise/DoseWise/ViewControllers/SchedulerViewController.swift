...
class SchedulerViewController:UIViewController{
    ...
    let intakeTrackerObj=intakeTracker()
    ...
    func pushReminder() {
        ...
        var currentCounting=intakeTrackerObj.getCounting()
    ...
    func selectYes() {
        intakeTrackerObj.confirming(isTaken: true)
        print("yes")
    }
    ...
    func selectIgnore() {
        intakeTrackerObj.confirming(isTaken: false)
        print("Ignore")
    }
